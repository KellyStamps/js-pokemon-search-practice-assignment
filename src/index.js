document.addEventListener("DOMContentLoaded", function() {
  ...
  class Pokemon {
    ...
    render () {
      ...
      newImgDiv.style = 'width:96px;margin:auto'
      newImgDiv.innerHTML = `<img src=${this.frontImage}>`


      let newPDiv = document.createElement('div')
      newPDiv.innerHTML = `<p style="padding:10px;" class="center-text flip-image" data-pokename=${this.name} data-action="flip-image">flip card</p>`
